...
train_gcnfc_dev(){
	python train_classifier_gcn.py \
...
python train_classifier_gcn.py --do_eval --load_model_path results/graph_bert_model/model_save --out_results_dir results/graph_bert_model --embeddings_data_dir combined.npy --dataset semcor
